...
from daash.base.models import BasePage
from daash.base.serializers import BasePageSerializer
...
class BlogPageTag(TaggedItemBase):
    ...
    parent_page_types = ['daashblog.BlogTagIndexPage']
...
class BlogPage(BasePage):
    ...
    parent_page_types = ['daashblog.BlogIndexPage']
    ...
    serializer = "daash.blog.serializers:BlogPageSerializer"
...
class BlogIndexPage(RoutablePageMixin, BasePage):
    parent_page_types = ['daashbase.HomePage']
