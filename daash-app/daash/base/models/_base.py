...
from daash.base.utils import get_class
from daash.base.validators import hex_validate
...
class SiteContent(SeriailizerMixin, ClusterableModel):
    ...
    serializer = "daash.base.serializers:SiteContentSerializer"
    ...
    def context_builder(self, request):
        ...
        if not context['base_context']:
            ...
            [
                ...
                for url in include('daash.front.urls')[0].context_patterns
            ]
...
class BasePageMixin(BaseMixin):
    serializer = "daash.base.serializers:BasePageSerializer"
